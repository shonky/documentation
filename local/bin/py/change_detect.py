...
def is_first_time_build():
    """
    Detect if deploy location not exist yet then its a first time build
    :rtype: bool
    """
...
def main():
    ...
    first_time_build = is_first_time_build()
    for lang in languages:
        if first_time_build:
            logger.info(f"First time build, triggering changes detected for {lang}..")
